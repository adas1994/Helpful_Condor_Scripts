...
if geom==35 and pm=='old':
    storage_base_dir = "/hadoop/store/user/adas/New_storeD35/StandardMixOld/Step4"
elif geom==35 and pm=='new':
    storage_base_dir = "/hadoop/store/user/adas/New_storeD35/StandardMixNew/Step4"
elif geom==41 and pm=='old':
    storage_base_dir = "/hadoop/store/user/adas/New_storeD41/StandardMixOld/Step4"
elif geom==41 and pm=='new':
    storage_base_dir = "/hadoop/store/user/adas/New_storeD41/StandardMixNew/Step4"
...
executable_name = "StandardStep4_driver.py"
...
def submit_jobs(njobs, qsub_scriptname, dirname = None):
    ...
    for i in range(njobs):
        ...
        rep["file_listpath"]   = os.path.join(base_dir, "filesfor_Standardstep4.txt")
        rep["configfile"]      = "step4_HARVESTING_PU.py"
