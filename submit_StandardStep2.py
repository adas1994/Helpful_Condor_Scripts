...
if geom==35 and pm=='old':
    storage_base_dir = "/hadoop/store/user/adas/New_storeD35/StandardMixOld/Step2"
elif geom==35 and pm=='new':
    storage_base_dir = "/hadoop/store/user/adas/New_storeD35/StandardMixNew/Step2"
elif geom==41 and pm=='old':
    storage_base_dir = "/hadoop/store/user/adas/New_storeD41/StandardMixOld/Step2"
elif geom==41 and pm=='new':
    storage_base_dir = "/hadoop/store/user/adas/New_storeD41/StandardMixNew/Step2"
...
executable_name = "StandardStep2_driver.py"
...
def submit_jobs(njobs, qsub_scriptname, dirname = None):
    ...
    for i in range(njobs):
        ...
        rep["configfile"]      = "step2_DIGI_L1_L1TrackTrigger_DIGI2RAW_HLT_PU.py"
