...
if geom==35 and pm=='old':
    storage_base_dir = "/hadoop/store/user/adas/EfficiencyD41OldPreMixMethod/StandardMixOld/Step3"
elif geom==35 and pm=='new':
    storage_base_dir = "/hadoop/store/user/adas/EfficiencyD41OldPreMixMethod/StandardMixNew/Step3"
elif geom==41 and pm=='old':
    storage_base_dir = "/hadoop/store/user/adas/New_storeD41/StandardMixOld/Step3"
elif geom==41 and pm=='new':
    storage_base_dir = "/hadoop/store/user/adas/New_storeD41/StandardMixNew/Step3"
...
executable_name = "StandardStep3_driver.py"
...
def submit_jobs(njobs, qsub_scriptname, dirname = None):
    ...
    for i in range(njobs):
        ...
        rep["file_listpath"]   = os.path.join(base_dir, "filesfor_Standardstep3.txt")
        rep["configfile"]      = "step3_RAW2DIGI_L1Reco_RECO_RECOSIM_PAT_VALIDATION_DQM_PU.py"
