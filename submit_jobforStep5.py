...
if geom==35 and pm=='old':
    storage_base_dir = "/hadoop/store/user/adas/New_storeD35/PreMixOld/Step5"
elif geom==35 and pm=='new':
    storage_base_dir = "/hadoop/store/user/adas/New_storeD35/PreMixNew/Step5"
elif geom==41 and pm=='old':
    storage_base_dir = "/hadoop/store/user/adas/New_storeD41/PreMixOld/Step5"
elif geom==41 and pm=='new':
    storage_base_dir = "/hadoop/store/user/adas/New_storeD41/PreMixNew/Step5"
...
executable_name = "step5driver.py"
...
def submit_jobs(njobs, qsub_scriptname, dirname = None):
    ...
    for i in range(njobs):
        ...
        rep["file_listpath"]   = os.path.join(base_dir, "filesfor_PremixStep5.txt")
        rep["configfile"]      = "step5_HARVESTING_PU.py"
