...
if geom==35 and pm=='old':
    storage_base_dir = "/hadoop/store/user/adas/New_storeD35/PreMixOld/Step3"
elif geom==35 and pm=='new':
    storage_base_dir = "/hadoop/store/user/adas/New_storeD35/PreMixNew/Step3"
elif geom==41 and pm=='old':
    storage_base_dir = "/hadoop/store/user/adas/New_storeD41/PreMixOld/Step3"
elif geom==41 and pm=='new':
    storage_base_dir = "/hadoop/store/user/adas/New_storeD41/PreMixNew/Step3"
...
executable_name = "step3driver.py"
...
def submit_jobs(njobs, qsub_scriptname, dirname = None):
    ...
    for i in range(njobs):
        ...
        rep["file_listpath"]   = os.path.join(base_dir, "TTBar_GenSim.txt")
        rep["configfile"]      = "step3_DIGI_DATAMIX_L1_L1TrackTrigger_DIGI2RAW_HLT.py"
        rep["mix_number"]      = str(i%250)
